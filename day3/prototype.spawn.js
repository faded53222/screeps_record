...
const creepConfigs=[ [[WORK,WORK,CARRY,MOVE], //harvester
                     ...
                     [],//lv4
                   [[WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], //harvester
...
[CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,
 MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE],//carrier
                      [],//defender
[CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,
 MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE],//picker
                      []//repairer
                     ]//lv5
                    ];
...
Spawn.prototype.mainSpawn = function(task_urgency) {
    ...
    if(task[0]==0){
        var spawnSuccess=this.spawnCreep(Body, Name, {memory: {role: task[0],lv: task[1],mother: this.name,site1: task[2],site2: task[3],site3:task[4],harvesting: true,reborn:1} });   
    }
    if(task[0]==1){
