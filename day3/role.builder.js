var biuld_priority_lis=[STRUCTURE_WALL,STRUCTURE_RAMPART,STRUCTURE_LINK,STRUCTURE_EXTENSION,STRUCTURE_ROAD,STRUCTURE_TOWER,STRUCTURE_CONTAINER,STRUCTURE_STORAGE];
var roleBuilder = {
    run: function(creep) {
